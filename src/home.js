    ...
    return(
        <div className='header' >
              <div className='second-div'>
                <div className='title' >
                  <h1 id="title">Hi I'm Frontend Developer</h1>
                  <h2 id="name">Rishabh gaud</h2>
                </div>
                <div id="photo">
                ...
                <div className='bottom-intro'>
                  <div className="box">
                    <h3>Introduction</h3>
                    <p> I am webdeveloper I had worked on React,express,github versioning and I can work with angular.
                      I have worked on lots of react project thats on my github account and I have hosted on vercel as well.
                      My main projects <br/>
                      <ul>
                        <li>Weather Frontend (react) I have integrated with  Openweather API </li>
                        <li>Draw histogram,bar graph,piechart and  parabola by filling values(font color,background color etc.) to form. </li>
                        <li>Notebook frontend where anyone can add,edit,delete and search.A visual calculater as well where by clicking button you can calculate values.</li>
                      </ul>
                    </p>
                  </div>
                  <div className="box">
                    ...
                    <p>
                      ...
                      Notebook frontend work have properly working of add by filling form,show by clicking on button to show all notes(delete ,edit and search as well).
